...
def lambda_handler(event, context):
    ...
    # Return updated list of team ids, this is important for the pipeline
    updated_teams = teams.get_teams()[:10]
    # updated_team_ids = [team['id'] for team in updated_teams]
    return {"teams": updated_teams}
